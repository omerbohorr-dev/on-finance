...
export const Contact: React.FC = () => {
  const [formData, setFormData] = useState({
    name: '',
    phone: '',
    type: 'finance', // default loan type (updated from check)
    message: ''
  });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Target phone number: 0544491815 -> 972544491815
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: 'On Finance',
          text: 'On Finance - פתרונות מימון מתקדמים, פתרונות פיננסים, אשראי ומשכון זהב.',
          ...
          <div className="grid md:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <p className="text-slate-600 text-lg mb-12">
                הצוות המקצועי שלנו זמין עבורך לכל שאלה. השאירו פרטים ונחזור אליכם בהקדם האפשרי עם הצעה אטרקטיבית וליווי צמוד.
              </p>
